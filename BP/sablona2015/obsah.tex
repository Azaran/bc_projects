...
TDEA je symetrická bloková šifra využívající kryptografické jádro DES k~šifrování\linebreak 64--bitového bloku
...
šifrovacího klíče. Počet opakování funkce je 10--krát pro 128--bitový klíč, \linebreak12--krát
...
%    }
%
%    \caption{Princip funkce SHA--1} \label{alg:SHA}
%\end{algorithm}
...
Archivy jsou soubory obsahující další soubory. Je možné je tedy považovat za \uv{schránky}, do
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|l|T{2.2cm}|T{2.2cm}|R|R|}
	    ...
	    \multirow{2}{*}{CPU} & Čas & 1m 33s & {\it 40m} & {\it 17h 20m 7s} & {\it 18d 18h 43m 8s} \\ 
            ...
            \hline
	    \multirow{2}{*}{GPU} & Čas & 25s & 2m 52s & {\it 1h 16m 10s} & {\it 1d 9h 14s} \\ 
                                 & Rychlost & 731 & 2658 & 2704 & 2704 \\ 
            \hline
        \end{tabularx}
...
\uv{hloupý} brute--force generátor jako původní verze {\it Wrathionu}. Jak {\it oclHashcat} tak
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|l|T{1.4cm}|T{1.4cm}|T{2.1cm}|R|}
	    ...
	    \multirow{2}{*}{CPU} & Čas & 1m 33s & {\it 40m} & {\it 17h 20m 7s} & {\it 18d 18h 43m 8s} \\ 
                                      & Rychlost& 198 & 198 & 198 & 198 \\ 
            \hline
	    \multirow{2}{*}{John the Ripper} & Čas & 1m 58s & {\it 53m 31s} & {\it 23h 11m 31s} &
		{\it 25d 2h 59m 20s} \\ 
	    ...
	    \multirow{2}{*}{GPU} & Čas & 25s & 2m 52s & {\it 1h 16m 10s} & {\it 1d 9h 14s} \\ 
            ...
            \hline
	    \multirow{2}{*}{oclHashcat} & Čas & 43s & 1m 7s & 4m 57s & {\it 9h 34m 31s} \\ 
                                     & Rychlost& 288 & 5146 & 10071 & 9320 \\ 
            \hline
	    \multirow{2}{*}{John the Ripper} & Čas & 10s & 1m 19s & {\it 1h 22m 23s} & {\it 1d
		11h 41m 49s} \\ 
...
Při použití GPU akcelerace se nám již objevuje další nástroj {\it oclHashcat}, jehož chování je
