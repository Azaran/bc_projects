...
\begin{table}[h]
    \begin{center}  
        ...
        \begin{tabularx}{\textwidth}{|l|l|R|R|R|R|R|R|R|}
            \cline{2-9}
            \multicolumn{1}{c|}{} & Délka hesla & 3 & 4 & 5 & 6 & 7 & 8 & 9 \\\hline
            \multirow{2}{*}{CPU} & Čas & 1s & 1s & 15s & 6m 2s & > 10m & > 10m & > 10m \\ 
                                 & Rychlost& - & - & 855018 & 899430 & 899430 & 899430 & 899430\\ 
            \hline
            \multirow{2}{*}{GPU} & Čas & 1s & 1s & 15s & 6m 2s & > 10m & > 10m & > 10m \\ 
                                 & Rychlost& - & - & 855018 & 899430 & 899430 & 899430 & 899430\\ 
            \hline
        \end{tabularx}
...
\begin{table}[h]
    \begin{center}  
        ...
        \begin{tabularx}{\textwidth}{|l|l|R|R|R|R|R|R|R|}
            \cline{2-9}
            \multicolumn{1}{c|}{} & Délka hesla & 3 & 4 & 5 & 6 & 7 & 8 & 9 \\\hline
            \multirow{2}{*}{CPU} & Čas & 1s & 1s & 13s & 5m 24s & > 10m & > 10m & > 10m \\ 
...
\begin{table}[h]
    \begin{center}  
        ...
        \begin{tabularx}{\textwidth}{|l|l|R|R|R|R|R|R|R|}
            \cline{2-9}
            \multicolumn{1}{c|}{} & Délka hesla & 3 & 4 & 5 & 6 & 7 & 8 & 9 \\\hline
            \multirow{2}{*}{CPU} & Čas & 1s & 1s & 12s & 4m 53s & > 10m & > 10m & > 10m \\ 
...
\begin{table}[h]
    \begin{center}  
        ...
        \begin{tabularx}{\textwidth}{|l|l|R|R|R|R|}
            ...
            \hline
            \multirow{2}{*}{GPU} & Čas & 1s & 1s & 15s & 6m 2s \\ 
...
\begin{table}[h]
    \begin{center}  
        ...
        \begin{tabularx}{\textwidth}{|l|l|R|R|R|R|R|R|}
            \cline{2-8}
            \multicolumn{1}{c|}{} & Velikost souboru & 1kB & 512kB & 1MB & 10MB & 100MB & 500MB \\\hline
            \multirow{2}{*}{CPU} & Čas & 1m 33s & 1m 33s & 1m 34s & 3m 23s & 1m 35s & 1m 38s \\ 
                                 & Rychlost& 198 & 198 & 198 & 126 & 198 & 192 \\ 
            \hline
            \multirow{2}{*}{GPU} & Čas & 1s & 1s & 15s & 6m 2s & > 10m & > 10m \\ 
...
\section{7zip srovnáníkonkurencí}
\shorthandoff{-}
\begin{table}[h]
    \begin{center}  
        \newcolumntype{R}{>{\raggedleft\arraybackslash}X}%
        \begin{tabularx}{\textwidth}{|l|l|R|R|R|R|}
            \cline{2-6}
            \multicolumn{1}{c|}{} & Délka hesla & 3 & 4 & 5 & 6 \\
            \hline
            \multirow{2}{*}{Wrathion} & Čas & 1m 33s & > 10m & > 10m & > 10m \\ 
                                      & Rychlost& 198 & 198 & 198 & 198 \\ 
            \hline
            \multirow{2}{*}{Hashcat} & Čas & ? & ? & ? & ? \\ 
                                     & Rychlost& ? & ? & ? & ? \\ 
            \hline
