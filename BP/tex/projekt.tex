...
\projectinfo{
  ...
  %Skolitel
  supervisor= Radek Hranicky, %jmeno prijmeni skolitele
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={ZIP, 7zip, obnova, archiv, GPU, OpenCL, ¹ifrování}, %klicova slova v ceskem jazyce
  keywords.en={ZIP, 7zip, recovery, archive, GPU, OpenCL, encrypting}, %klicova slova v anglickem jazyce
  %Abstract
