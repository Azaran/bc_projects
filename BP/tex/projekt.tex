...
\projectinfo{
  ...
  %Abstract
  abstract.cs={Práce se zabývá problematikou vývoje aplikací s~paralelními výpoèty, analýzou
      formátù .ZIP a .7z a následným návrhem modulù pro roz¹íøení funkcionality nástroje Wrathion.
  }, % abstrakt v ceskem jazyce
  abstract.en={This thesis is covering topics concerning development of paralel aplications,
  analysis of file formats .ZIP and .7z and at the end it contains design of extensional modules
  for both formats for aplication Wrathion.}, % abstrakt v anglickem jazyce
  %Prohlaseni
  declaration={Prohla¹uji, ¾e jsem tuto bakaláøskou práci vypracoval samostatnì pod vedením pana Ing. Radka Hranického},
