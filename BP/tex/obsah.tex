...
se zøetìzeným rendrováním grafických prvkù\cite{Khronos:2015}.\\
Standard:
\begin{itemize}
...
\begin{itemize}
	\item In-order -- pøíkazy se provádí a mají efekt tak jak do fronty pøisly
	\item Out-of-order -- poøadí provedení pøíkazù je omezeno pouze explicitnì uvedenými
	    synchronizaèními body nebo explicitnì definovanými závislostmi na událostech
\end{itemize}
-- pokraèuj OpenCL strana 29, deleni na instance kernelu atd.
\subsection{OpenCl C}
