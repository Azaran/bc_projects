...
na které pobì¾í kernel.

 Tento problém lze vyøe¹it tak, ¾e pomocí GPU pouze první tøí kroky Algoritmu~\ref{alg:7z_desifr}
na 16 bajtovém vzorku dat. Ten pak otestujeme, zda se jeho první bajt rovná 0x00 nebo zda se jeho
první tøi bajty rovnají 0x010406. Pokud ano, tak heslo oznaèíme jako potenciální správné heslo a
otestujeme ho na CPU nad celými daty.
...
\section{Implementace modulu 7z (SevenZ)}
...
u 7z. Cimz by se 7z Crackovani urychlilo.
%=========================================================================
