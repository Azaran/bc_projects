...
tématem na poli informaèních technologií. edno, jestli se bavíme o~zabezpeèení dat pøi pøenosu
...
algoritmù u~tìchto formátù a následnì získáváním hesel k~takto zabezpeèeným souborùm. Výsledky analýz jsou pou¾ity pro návrh roz¹iøujících modulù nástroje {\it Wrathion}. Práce se také
...
\begin{itemize}
    ...
    \item Objekty kernelu -- OpenCL funkce s~pøednastavenými argumenty podle vybraného
        zaøízení.
    \item Objekty programu -- zdrojový kódu a jeho spustitelná verze, které implementují
        kernely.
...
V~pøípadì tohoto modulu se budu zabývat roz¹íøením funkcionality a ne vytvoøením zcela nového
modulu.
...
speciální verzi AES, je¾ si vytvoøili vývojáøi nástroje WinZip. Ti si vytvoøili vlastní oøezanou
...
archivù, které tento modul nezvládne zpracovat.
...
modifikovat na základì informací zji¹tìných bìhem implementace jednotlivých èástí modulu.
 ...
 Bìhem implementace bude zapotøebí vytvoøit dvì verze obou modulù. Jednu verzi bezici pouze na
CPU a druhou, která bude podporovat paralelní zpracování na GPU. V návaznosti na implementaci
bude potøeba provést mìøení rychlosti a následné srovnání s konkurencí. Podle výsledkù srovnání
jde odhadnout jak moc optimální ná¹ modul je a zda je tøeba ho nìjak upravit a vyladit nebo
jestli je v rámci mo¾ností vykonovì optimalizován. 

  Na konci bude tøeba provést objektivní srovnání s konkurencí a urèit, pro které pøíkpady je
vhodné pou¾ít jaký nástroj.
