...
CRC-32\footnote{{\it Cyclic Redundancy Code} - speciální hashovací funkce slou¾ící pro detekci
...
7-zip a nástrojù spojených s~tímto formátem (7-Max, 7-Benchamark). Formát se proslavil hlavnì
...
následek znatelnou prodlevu ne¾ zaène komprese souborù a ¹ifrování.
