...
Zde se standardnì spustí ji¾ pøedkompilovaný cracker napsaný v~C++ (viz. Obr.\ref{CPU}). Není zde
¾ádný vìt¹í problém s~generováním ani následným ovìøováním hesel, ov¹em výpoèetní síla
...
Cracker mù¾e pracovat ve dvou re¾imech (viz. Obr. \ref{CPUGPU}). V~prvním hesla generujeme na CPU
a pak je posíláme do pamìti GPU, kde jsou crackerem zpracována. To má ov¹em velkou nevýhodu v~tom,
¾e musíme poøád posílat data z~pamìti hostitele (CPU) do privátní pamìti výpoèetního prvku
...
pou¾ita kompresní metoda, co je vy¾adováno pro de¹ifrování, jestli je vy¾adováno heslo nebo pouze
certifikát nebo jedna z~obou uvedených, tedy heslo nebo certifikát, pøípadnì dal¹í mo¾nosti
v~souvislosti s~pou¾itým certifikátem.
